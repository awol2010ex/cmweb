...
public class TCmTimeTaskDAOImpl extends HibernateDao<TCmTimeTaskVO, String>
	...
	public TCmTimeTaskVO getTask(String taskCode) throws Exception {
		...
		map.put("ID", taskCode);
		return (TCmTimeTaskVO)sqlSession.selectOne("com.cmweb.cognos8.getAllTimeTaskList", map);
	}
	...
	public List<TCmTimeTaskVO> getAll() {
		return sqlSession.selectList("com.cmweb.cognos8.getAllTimeTaskList",new HashMap<String,Object>());
	}
}
